...
public class NimRODScrollPaneUI extends BasicScrollPaneUI
{
	...
	public void paint(Graphics g, JComponent c)
	{
		...
		// tamao del JScrollPane se reevalua el tamao necesario, lo que puede provocar un relayaut si ha cambiado
		// el tamo de lo que contiene, por ejemplo, si se despliegan unos nodos en un arbol...
		// Para solucionarlo se guarda el tamao del scrollpane al empezar a pintar y se pone al terminar.
			...
			if (cc != null)
			{
				try
				{
					...
					if (bb != null && bb instanceof NimRODBorders.NimRODGenBorder)
					{
						...
						// Aqui se vuelve a poner el tamao que tenia al principio, por el bug ese descubierto por Fabian Voith.
