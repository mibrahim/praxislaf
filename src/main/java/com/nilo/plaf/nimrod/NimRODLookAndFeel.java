 ...
 * </code> You can change the default theme color in two ways.
 *
 ...
 *   UIManager.setLookAndFeel( NimRODLF);
 *   <code><br>
 * This way is good if you can change the sources and you want the program works
 * *only* with NimRODLF.
 *
 * If you don't have the sources you can change the theme color including same
 * properties in your command line and the look and feel will do its best...
 * This couldn't work if the application changes the system properties, but,
 * well, if you don't have the sources...<br>
 * For example:<br>
 * <code>java -Dnimrodlf.selection=0x00cc00 XXX.YOUR.APP.XXX</code> will colour
 * with green the selected widgets<br>
 * <code>java java -Dnimrodlf.s1=0xdde8ee -Dnimrodlf.s2=0xb7daec -Dnimrodlf.s3=0x74bfe6 XXX.YOUR.APP.XXX</code>
 * will colour with blue the background of the widgets<br>
 * The values are in the tipical HTML format (0xRRGGBB) with the red, green and
 * blue values encoded in hexadecimal format.<br>
 ...
 * <li>nimrodlf.p1: this is the primary1 color (Don't you understand?
 * Patience?</li>
 ...
 * </ul>
 * Primary color? Secondary? What the...? Cool. <a
 * href='http://java.sun.com/products/jlf/ed1/dg/higg.htm#62001'>Here</a> you
 * can learn what i'm talking about. Swing applications have only 8 colors,
 * named PrimaryX, SecondaryX, White and Black, and <a
 * href='http://java.sun.com/products/jlf/ed1/dg/higg.htm#62001'>here</a>
 * you hava a table with the who-is-who.<br>
 * You don't need to write all the values, you only must write those values you
 * want to change. There are two shorthand properties, selection and background.
 * If you write nimrodlf.selection or nimrodlf.background the NimRODLF will
 * calculate the colors around (darker and lighter) your choose.<br>
 * If nimrodlf.selection is writen, pX, sX, b and w are ignored. Ahh!! One more
 * thing. 0xRRGGBB is equal #RRGGBB.
 *
 * @see NimRODTheme
...
public class NimRODLookAndFeel extends MetalLookAndFeel
{
    ...
    // Vamos a ver si han puesto por linea de comandos un fichero de tema...
		...
		{    // Si no se puede leer el fichero o el fichero esta malamente,
	...
	/**
	 * Este metodo devuelve false porque para dar bordes como es debido a la
	 * ventana principal hay que fusilarse la clase MetalRootPaneUI enterita
	 * porque la mayoria de sus metodos son privados... Ademas, no es mala idea
	 * que la decoracion de la ventana principal la ponga el sistema operativo
	...
	protected void initComponentDefaults(UIDefaults table)
	{
		...
		// el borde de ScrollPane, NetBeans 5.5 se queda tieso cuando cierras todas las pestaas del panel principal...
